...
DATA_DIR_ON_PRIVATE="${DATA_DIR_ON_PRIVATE:-${APP_DIR_ON_PRIVATE}/data}"
...
ssh "${BASTION_HOST}" \
  ...
  GCP_KEY_ON_PRIVATE="${GCP_KEY_ON_PRIVATE}" DATA_DIR_ON_PRIVATE="${DATA_DIR_ON_PRIVATE}" \
...
ssh "${PRIVATE_HOST}" \
  ...
  DATA_DIR_ON_PRIVATE="${DATA_DIR_ON_PRIVATE}" FRONTEND_HOST_PORT="${FRONTEND_HOST_PORT}" \
...
install -d "${DEPLOY_ROOT}/releases" "${RELEASE_DIR}" "${DATA_DIR_ON_PRIVATE}"
